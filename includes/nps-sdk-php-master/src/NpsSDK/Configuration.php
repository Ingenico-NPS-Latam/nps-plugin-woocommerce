...
class Configuration
{
    ...
    {   
        switch(self::environment()) {
         ...
         case 'sandbox':
             ...
             break;
         case Constants::CUSTOM_ENV:
             $url = self::$global->getCustomUrl();
             break;
         default:
    ...
    public static function customUrl($value=null){
        if (is_null($value)) {
            return self::$global->getCustomUrl();
        }
        self::$global->setCustomUrl($value);
    }    
