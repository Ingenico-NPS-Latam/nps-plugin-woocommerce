...
class Utils{
    ...
    {
        $info = array("SdkInfo" => Constants::SDK_NAME . " Version: " . Version::VERSION);
    ...
    public static function addSecureHash($params, $key)
    {
      ...
      $secure_hash = self::createHmacSha256Hash($concatenated_data, $key);
    ...
    public static function createHmacSha512Hash($data, $key) {
